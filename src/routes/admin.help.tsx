...
const ADMIN_TOPICS: Topic[] = [
  ...
  },
  {
    ...
    what: "Give your buyers their own read-only portal. Each client account has a login email + password, linked locations (what they can see) and a buyer name that connects their billing to Buyer Income.",
    steps: [
      "Add Client → contact name, company, login email, initial password.",
      "Buyer name defaults to the company — it must match the buyer name used in Buyer & Profit/Loss for billing to appear.",
      "Tick the locations this client may see, then Create.",
      "The client signs in on the Client tab of the login page.",
      "Use the row actions to edit details/locations, reset their password or delete the account.",
    ],
  ...
  },
  {
    ...
    notes: ["Buyer name here is what links a Client account's Billing tab — keep the spelling identical."],
  },
  {
    icon: BarChart3,
    title: "Reports",
